    ...
    return (
        <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 h-full flex flex-col">
            ...
            <div className="p-6 flex flex-col flex-grow space-y-4">
                ...
                {/* Button */}
                <div className="h-12 bg-gray-200 rounded-lg w-full animate-pulse mt-auto" />
            </div>
        </div>
    )
}
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div className="space-y-4">
                    <div className="aspect-square bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl animate-pulse" />
...
export function StatCardSkeleton() {
    return (
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            ...
            <div className="h-8 bg-gray-300 rounded w-32 animate-pulse mb-2" />
            <div className="h-3 bg-gray-200 rounded w-20 animate-pulse" />
        </div>
    )
}
